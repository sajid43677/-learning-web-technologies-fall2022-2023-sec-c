		...
		<main>
			<div align="center" class="welcome">Welcome To Admin Homepage</div>
				<div class="container">
					...
					<a class="a1" href="../../controller/admin/updateEmp.php" ><h4>Update Employees Profile</h4></a>
					<a class="a1" href="../../controller/admin/EmpInfo.php"><h4>Employees Information</h4></a>
